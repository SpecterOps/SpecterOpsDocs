---
title: "Mythic"
description: "A cross-platform, post-exploit, red teaming framework designed to provide a collaborative and user friendly interface for operators."
---
...
<Frame>
<img src="./images/version-3.3/image-1-1.png"/>
</Frame>
...
- Join the #Mythic channel in the [BloodHound public slack](/message-flow/building-payloads)

- Reach out on Twitter: [@its_a_feature\_](https://twitter.com/its_a_feature_)
