...
There are a few things needed to make a C2 container. For reference on general code structure options, check out [1. Payload Type Development](/Mythic_docs/customizing/payload-type-development). The general structure is the same for Payload Types, C2 Profiles, and Translation containers.
...
<Frame>
    <img src="../../../images/version-3.3/image-1-64.png"/>
</Frame>

<Frame>
    <img src="../../../images/version-3.3/image-1-65.png"/>
</Frame>
