---
title: 'GhostPack'
description: 'A collection of C# offensive security tools for Windows and Active Directory environments'
icon: 'ghost'
---

<div style={{ textAlign: 'center', marginBottom: '20px' }}>
  <img src="/ghostpack-docs/ghostpack-logo.png" alt="GhostPack" style={{ maxWidth: '300px' }} />
</div>
...
<CardGroup cols={2}>
  ...
  <Card
    title="SafetyKatz"
    icon="shield"
    href="https://github.com/GhostPack/SafetyKatz"
  >
...
<CardGroup cols={2}>
  ...
  <Card
    title="KeeThief"
    icon="vault"
    href="https://github.com/GhostPack/KeeThief"
  >
...
<CardGroup cols={2}>
  <Card
    title="Lockless"
    icon="lock-open"
    href="https://github.com/GhostPack/Lockless"
  >
    **Locked File Access**
  ...
  <Card
    title="SharpDump"
    icon="download"
    href="https://github.com/GhostPack/SharpDump"
  >
  ...
  <Card
    title="PSPKIAudit"
    icon="shield-check"
    href="https://github.com/GhostPack/PSPKIAudit"
  >
    **AD CS Auditing**
  ...
  <Card
    title="DeepPass"
    icon="database"
    href="https://github.com/GhostPack/DeepPass"
  >
    **Password Analysis**
...
<CardGroup cols={2}>
  <Card
    title="RAGnarok"
    icon="robot"
    href="https://github.com/GhostPack/RAGnarok"
  >
  ...
  <Card
    ...
    icon="user-lock"
    href="https://github.com/GhostPack/RestrictedAdmin"
  >
...
<CardGroup cols={3}>
  ...
  <Card
    title="HarmJ0y Blog"
    icon="blog"
    href="http://www.harmj0y.net/blog/"
  >
...
- [@tifkin_](https://twitter.com/tifkin_) (Lee Christensen)
